...
class PreferencesDialog(Gtk.Dialog):
	def __init__(self):
		...
		table1.attach(label_long_break,0,1,2,3, xpadding=5, ypadding=5)
		self.spinbutton3 = Gtk.SpinButton()
		self.spinbutton3.set_adjustment(Gtk.Adjustment(25, 1, 1440, 1, 10, 0))
		table1.attach(self.spinbutton3,1,2,2,3, xpadding=5, ypadding=5)

		label4 = Gtk.Label(_('Play sounds')+':')
		label4.set_alignment(0, 0.5)
		table1.attach(label4,0,1,4,5, xpadding=5, ypadding=5)
		self.switch4 = Gtk.Switch()
		table1.attach(self.switch4,1,2,4,5, xpadding=5, ypadding=5, xoptions = Gtk.AttachOptions.SHRINK)
		...
		table1.attach(self.comboboxsound5,1,2,5,6,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)			
		...
		table1.attach(self.comboboxsound6,1,2,6,7,xoptions=Gtk.AttachOptions.FILL, yoptions=Gtk.AttachOptions.FILL, xpadding=5, ypadding=5)					
		...
		table1.attach(self.switch7,1,2,7,8, xpadding=5, ypadding=5, xoptions = Gtk.AttachOptions.SHRINK)
		...
		table1.attach(self.switch8,1,2,8,9, xpadding=5, ypadding=5, xoptions = Gtk.AttachOptions.SHRINK)
	...
	def save_preferences(self):
		...
		configuration.set('session_sound_file',get_selected_value_in_combo(self.comboboxsound5))
		configuration.set('break_sound_file',get_selected_value_in_combo(self.comboboxsound6))
		create_or_remove_autostart(self.switch7.get_active())
		if self.switch8.get_active() == True:
