...
DATA_FILES = [
    (os.path.join(DESTDIR, 'bin'), glob.glob('bin/*')),
    (os.path.join(SHAREDIR, 'pomodoro-indicator'), ['debian/changelog']),
    (os.path.join(SHAREDIR, 'pomodoro-indicator'), glob.glob('src/*.py')),
    (os.path.join(SHAREDIR, 'pomodoro-indicator'),
     ['data/pomodoro-indicator-autostart.desktop']),
    (os.path.join(SHAREDIR, 'pomodoro-indicator', 'sounds'),
